    ...
    <div class="container">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-2"><strong>Khu
                                        vực:</strong><br>{{ $chiTiet->khu_vuc ?? 'N/A' }}@if($chiTiet->tang) - Tầng
                                    {{ $chiTiet->tang }}@endif</p>
                        ...
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body">
                                <p class="mb-2">
                                    ...
                                    <span
                                        class="badge bg-light text-dark fs-6">{{ $chiTiet->gio_vao ? $chiTiet->gio_vao->format('d/m/Y H:i') : 'N/A' }}</span>
                                </p>
                                <p class="mb-2">
                                    <strong>Giờ ra:</strong><br>
                                    <span
                                        class="badge bg-light text-dark fs-6">{{ $chiTiet->gio_ra ? $chiTiet->gio_ra->format('d/m/Y H:i') : 'N/A' }}</span>
                                </p>
                                <p class="mb-0">
                                    <strong>Thời gian phục vụ:</strong><br>
                                    <span
                                        class="badge bg-success fs-6">{{ floor($chiTiet->thoi_gian_phuc_vu_phut / 60) }}
                                        giờ {{ $chiTiet->thoi_gian_phuc_vu_phut % 60 }} phút</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                $soNguoiDuocGiam = 0;
                                if($soTreEm > 0 && $soNguoiDaXuLy < $soTreEm) { // Số người được giảm=min(số trẻ em còn
                                    lại, số lượng combo này) $soTreEmConLai=$soTreEm - $soNguoiDaXuLy;
                                    $soNguoiDuocGiam=min($soTreEmConLai, $soLuongCombo); } // Tính số người không giảm
                                    giá $soNguoiKhongGiam=$soLuongCombo - $soNguoiDuocGiam; $soNguoiDaXuLy
                                    +=$soLuongCombo; // Tăng số người đã xử lý @endphp
                                    {{-- Hiển thị combo với giá giảm 50% (nếu có) --}} @if($soNguoiDuocGiam> 0)
                                    @php
                                    ...
                                    <div class="mb-3 p-3 bg-light rounded border border-warning">
                                        <h6 class="fw-bold text-primary mb-2">
                                            <i
                                                class="bi bi-star-fill me-1 text-warning"></i>{{ $chiTietCombo->combo->ten_combo }}
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3 p-3 bg-light rounded border border-warning">
                                    ...
                                    <p class="mb-1"><strong>Giá combo:</strong>
                                        {{ number_format($chiTiet->gia_combo_per_person) }} đ/người</p>
                                    <p class="mb-1"><strong>Số khách:</strong> {{ $chiTiet->so_khach }} người
                                        <small class="text-muted">(Người lớn:
                                            {{ $chiTiet->nguoi_lon ?? $hoaDon->datBan->nguoi_lon ?? 0 }}, Trẻ em:
                                            {{ $chiTiet->tre_em ?? $hoaDon->datBan->tre_em ?? 0 }})</small>
                                    </p>
                                    <p class="mb-0 mt-2"><strong>Thành tiền combo:</strong>
                                        <span
                                            class="text-danger fw-bold fs-5">{{ number_format($chiTiet->tong_tien_combo) }}
                                            đ</span>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                foreach($hoaDon->datBan->chiTietDatBan as $chiTietCombo) {
                                if($chiTietCombo->combo) {
                                $monTrongCombo = \App\Models\MonTrongCombo::where('combo_id',
                                $chiTietCombo->combo->id)->get();
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $soLuongDangCheBienTrongVuot = min($soLuongDangCheBien,
                                            $soLuongConLaiTrongVuot);
                                            $soLuongChoBepTrongVuot = $soLuongConLaiTrongVuot -
                                            $soLuongDangCheBienTrongVuot;
                                            }

                                            // Tính tổng số lượng từ order (bao gồm cả món đã hủy)
                                            $tongSoLuongHienThi = $monAnGroup->sum('so_luong');
                                            } else {
                                            // Nếu không có monAnGroup (món đã bị xóa), sử dụng số lượng từ
                                            danh_sach_mon
                                            ...
                                            $coMonChuaNauXong = $soLuongChuaNauXong > 0 || $soLuongChuaNauXongTrongVuot
                                            > 0;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="d-flex flex-column align-items-center">
                                                        <span class="badge bg-danger mb-1">Đã hủy:
                                                            {{ $soLuongHuy }}/{{ $tongSoLuongHienThi }}</span>
                                                    </div>
                                                    @elseif($soLuongDaLen == $tongSoLuongKhongHuy && $soLuongHuy == 0 &&
                                                    $soLuongDangCheBien == 0 && $soLuongChoBep == 0)
                                                    {{-- Tất cả đã lên, không có trạng thái khác --}}
                                                    <div class="d-flex flex-column align-items-center">
                                                        <span class="badge bg-success">Đã lên:
                                                    ...
                                                    <div class="d-flex flex-column align-items-center gap-1">
                                                        ...
                                                        <span class="badge bg-warning text-dark">Đang nấu:
                                                            {{ $soLuongDangCheBien }}</span>
                                                        @endif
                                                        @if($soLuongChoBep > 0)
                                                        <span class="badge bg-info text-white">Chờ bếp:
                                                            {{ $soLuongChoBep }}</span>
                                                        @endif
                                                        @if($soLuongHuy > 0)
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    @if($soLuongHuy > 0)
                                                    <br><small class="text-danger">Đã hủy ({{ $soLuongHuy }}): 0
                                                        đ</small>
                                                    @endif
                                                    @elseif($donGiaGoc > 0 || $coMonChuaNauXong || $soLuongVuot > 0)
                                                    {{-- Món vượt giới hạn hoặc món gọi thêm: hiển thị chi tiết --}}
                                                    <div>
                                                        <small class="text-muted">Giá gốc:
                                                            {{ number_format($donGiaGoc) }} đ</small>
                                                        @if($soLuongHuy > 0)
                                                        <br><small class="text-danger">Đã hủy ({{ $soLuongHuy }}): 0
                                                            đ</small>
                                                        @endif
                                                        ...
                                                        <small class="text-warning">
                                                            ...
                                                            Đã nấu xong ({{ $soLuongDaLenTrongVuot }}): 100% =
                                                            {{ number_format($donGiaGoc * $soLuongDaLenTrongVuot) }} đ
                                                            @if($soLuongChuaNauXongTrongVuot > 0)
                                                            <br>
                                                            @if($soLuongDangCheBienTrongVuot > 0)
                                                            Đang nấu dở ({{ $soLuongDangCheBienTrongVuot }}): 100% =
                                                            {{ number_format($donGiaGoc * $soLuongDangCheBienTrongVuot) }}
                                                            đ
                                                            ...
                                                            @if($soLuongDangCheBienTrongVuot > 0)
                                                            Đang nấu dở ({{ $soLuongDangCheBienTrongVuot }}): 30% =
                                                            {{ number_format($donGiaGoc * 0.3 * $soLuongDangCheBienTrongVuot) }}
                                                            đ
                                                            @if($soLuongChoBepTrongVuot > 0)
                                                            <br>
                                                            Chờ bếp ({{ $soLuongChoBepTrongVuot }}): 0 đ
                                                            ...
                                                            @elseif(!$coTrongCombo)
                                                            @if($soLuongDaLen > 0)
                                                            Đã nấu xong ({{ $soLuongDaLen }}): 100% =
                                                            {{ number_format($donGiaGoc * $soLuongDaLen) }} đ
                                                            @if($soLuongChuaNauXong > 0)
                                                            <br>
                                                            @if($soLuongDangCheBien > 0)
                                                            Đang nấu dở ({{ $soLuongDangCheBien }}): 100% =
                                                            {{ number_format($donGiaGoc * $soLuongDangCheBien) }} đ
                                                            @if($soLuongChoBep > 0)
                                                            <br>
                                                            ...
                                                            @if($soLuongDangCheBien > 0)
                                                            Đang nấu dở ({{ $soLuongDangCheBien }}): 30% =
                                                            {{ number_format($donGiaGoc * 0.3 * $soLuongDangCheBien) }}
                                                            đ
                                                            @if($soLuongChoBep > 0)
                                                            <br>
                                                            Chờ bếp ({{ $soLuongChoBep }}): 0 đ
                                                    ...
                                                    <small class="text-danger">
                                                        ...
                                                        <br><small class="text-muted">({{ number_format($phuPhiDonVi) }}
                                                            đ × {{ $soLuongDaLenTrongVuot }})</small>
                                                        @endif
                                                    </small>
                                                    @endif
                                                    @else
                                                ...
                                                <td class="text-end fw-bold">
                                                    @if($monAnGroup && $soLuongHuy > 0 && isset($tongSoLuongHienThi) &&
                                                    $soLuongHuy == $tongSoLuongHienThi)
                                                    {{-- Tất cả món đã hủy --}}
                                                    <span class="text-danger">0 đ</span>
                                                    @elseif($thanhTien > 0)
                                            ...
                                            $tongTienMonGoiThem = $tongTienMonGoiThemTinhLai; // Tính từ bảng để hiển
                                            thị chi tiết
                                            $tongCong = $chiTiet->tong_tien_combo_mon ?? $hoaDon->tong_tien ?? 0;
                                            @endphp
                                            ...
                                            <tr class="table-warning fw-bold">
                                                <td colspan="5" class="text-end">
                                                    <i class="bi bi-star-fill text-warning me-1"></i>Tổng tiền combo
                                                    chính:
                                                </td>
                                                <td class="text-end text-primary fs-5">
                                                    {{ number_format($tongTienComboTinhLai) }} đ</td>
                                            </tr>
                                            @endif
                                            @if($tongTienMonGoiThem > 0)
                                            <tr class="table-secondary fw-bold">
                                                <td colspan="5" class="text-end">Tổng tiền món gọi thêm:</td>
                                                <td class="text-end text-info">{{ number_format($tongTienMonGoiThem) }}
                                                    đ</td>
                                            </tr>
                                            @endif
                        ...
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body">
                                <div class="p-4 bg-white rounded-3 border shadow-sm">
                                    ...
                                    if($tongTienSauVoucher < 0) $tongTienSauVoucher=0; // Phải thanh toán từ
                                        chi_tiet_hoa_don $phaiThanhToan=$chiTiet->phai_thanh_toan ??
                                        ($tongTienSauVoucher - ($chiTiet->tien_coc ?? 0));
                                        if ($phaiThanhToan < 0) $phaiThanhToan=0; @endphp <div
                                            class="d-flex justify-content-between mb-2">
                                            <span class="text-dark">Tổng tiền (Combo + Món):</span>
                                            <strong class="text-primary fs-5">{{ number_format($tongTienComboMon) }}
                                                đ</strong>
                                </div>
                                @if($chiTiet->tien_giam_voucher > 0)
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-dark">(-) Tiền giảm (Voucher):</span>
                                    <strong class="text-success">- {{ number_format($chiTiet->tien_giam_voucher) }}
                                        đ</strong>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-dark fw-bold">Tổng tiền sau voucher:</span>
                                    <strong class="text-warning fs-5">{{ number_format($tongTienSauVoucher) }}
                                        đ</strong>
                                </div>
                                @endif
                                ...
                                <div class="d-flex justify-content-between mt-2 fs-5">
                                    ...
                                    <span
                                        class="text-{{ $hoaDon->trang_thai == 'chua_thanh_toan' ? 'warning' : 'success' }}">
                                ...
                                @elseif($chiTiet->tien_khach_dua < $phaiThanhToan) <div
                                    class="d-flex justify-content-between mt-2">
                                    <span class="text-danger">Thiếu:</span>
                                    <strong
                                        class="text-danger">{{ number_format($phaiThanhToan - $chiTiet->tien_khach_dua) }}
                                        đ</strong>
                            </div>
                            @endif
                            @endif
                            <div class="mt-3 pt-3 border-top">
                                <p class="mb-0"><strong>Phương thức thanh toán:</strong>
                                    @if($hoaDon->trang_thai == 'chua_thanh_toan' || $chiTiet->phuong_thuc_tt ==
                                    'chua_thanh_toan')
                                ...
                                <p class="mb-0 mt-2"><strong>Voucher:</strong> <span
                                        class="badge bg-info">{{ $chiTiet->ma_voucher }}</span></p>
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <p>Số khách: {{ $hoaDon->datBan->so_khach ?? 'N/A' }}
                    <small class="text-muted">(Người lớn: {{ $hoaDon->datBan->nguoi_lon ?? 0 }}, Trẻ em:
        ...
        <div class="d-flex justify-content-center gap-3 mt-4">
            ...
            <a href="{{ route('nhanVien.thanh-toan.in-hoa-don', $hoaDon->id) }}" target="_blank"
                class="btn btn-primary btn-lg">In hóa đơn</a>
        </div>
    </div>
</div>
</div>
