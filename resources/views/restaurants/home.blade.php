                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex align-items-center product-card-trigger rounded p-3 bg-white shadow-sm h-100"
                                ...
                                data-price="{{ $combo->gia_co_ban }}" data-desc="{{ $combo->mo_ta }}"
                                data-img="{{ $imageUrl }}"
                                ...
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                        ...
                                        <span class="text-primary">{{ number_format($combo->gia_co_ban, 0, ',', '.') }}
                                            đ</span>
                                    </h5>
                                    <small class="fst-italic text-muted mb-2"><i class="fa fa-clock me-1"></i> Không
                                        giới hạn</small>
                                    <small
                                        class="fst-italic text-secondary line-clamp-2">{{ \Illuminate\Support\Str::limit($combo->mo_ta, 60) }}</small>
