            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="{{ route('nhanVien.ban-an.index') }}" class="nav-item nav-link {{ request()->routeIs('nhanVien.ban-an.*') ? 'active' : '' }}">Bàn ăn</a>
                        <a href="{{ route('nhanVien.order.index') }}" class="nav-item nav-link {{ request()->routeIs('nhanVien.order.*') ? 'active' : '' }}">Mở order gọi món</a>
                        <a href="{{ route('nhanVien.datban.index') }}" class="nav-item nav-link {{ request()->routeIs('nhanVien.datban.*') ? 'active' : '' }}">Xác nhận & tạo đặt bàn</a>
                    </div>
                     {{-- Nút Logout (Ví dụ) --}}
                     <a href="#" class="btn btn-primary py-2 px-4">Đăng xuất</a>
                </div>
            </nav>
